...
Button:
A button will be used to work with the mechanism. The button will be programmed with the circuilt playground express to allow for user input when unlocking the mechanism. It will then connect to the alert system or door servo based on whether the unlocking mechanism fails or succeeds.
